...
You can install Heyoffline via Bower with `bower install Heyoffline` or download `heyoffline.js` and include it the old-fashioned way.
...
<table>
  ...
  <tr>
    ...
    <td>boolean</td>
    <td>false</td>
    <td class="desc">Don't use the default CSS (generated by JS), you can use the `heyoffline.css` with defaults instead.</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td>onOnline</td>
    <td></td>
    <td>Fires when the network becomes available</td>
  </tr>
  <tr>
    <td>onOffline</td>
    <td></td>
